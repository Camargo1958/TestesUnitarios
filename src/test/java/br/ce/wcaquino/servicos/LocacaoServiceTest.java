...
public class LocacaoServiceTest {
	...
	public void deveEnviarEmailParaLocacoesAtrasadas(){
	  ...
	  //Verificacao
	  verify(emailService, times(3)).notificarAtraso(ArgumentMatchers.any(Usuario.class));
	...
	public void devemosPagar50PctNoFilme4() throws Exception {
		...
		//Verificacao
		int i; Double valorTotal = 0d; Double precoLocacaoFilme = 0d;
	...
	public void naoDeveAlugarFilmeParaNegativadoSPC() throws Exception {
	  ...
	  when(spc.possuiNegativacao(ArgumentMatchers.any(Usuario.class))).thenReturn(true);
